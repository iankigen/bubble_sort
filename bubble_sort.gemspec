...
Gem::Specification.new do |spec|
  ...
  spec.summary = %q{Bubble Sort}
  spec.description = %q{Bubble sort, sometimes referred to as sinking sort, is a simple sorting algorithm that
...
list is sorted.}
  spec.homepage = 'https://github.com/iankigen/bubble_sort'
  spec.license = "MIT"
